...
struct Lidar
{
		...
		: cloud(new pcl::PointCloud<pcl::PointXYZ>()), position(0,0,2.6)
	{
		...
		sderr = 0.2; // this is noise; necessary to efficiently learn
		cars = setCars;
		groundSlope = setGroundSlope;

		// TODO:: increase number of layers to 8 to get higher resoultion pcd
		int numLayers = 8; // laser layers over height
		...
		double horizontalAngleInc = pi/64; // circumferential lasers resolution
